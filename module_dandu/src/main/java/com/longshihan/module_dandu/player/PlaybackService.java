...
public class PlaybackService extends Service implements IPlayback, IPlayback.Callback {
    ...
    private void showNotification(PlayState status) {
        ...
        PendingIntent contentIntent = PendingIntent.getActivity(this, 0, new Intent(this, DanduActivitymainActivity2.class), 0);
    ...
    private void setUpRemoteView(RemoteViews remoteView) {
        ...
        remoteView.setTextViewText(R.id.text_view_name,tilte);
        remoteView.setTextViewText(R.id.text_view_artist,name);
