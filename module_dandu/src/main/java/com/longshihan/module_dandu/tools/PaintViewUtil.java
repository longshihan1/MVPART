...
import com.longshihan.module_dandu.widget.SelectTextView;
...
public class PaintViewUtil {
    ...
    private void addH3TextView(Context paramContext, ViewGroup paramViewGroup, SpannableStringBuilder paramSpannableStringBuilder, int paramInt1, int
    ...
    private void addH4TextView(Context paramContext, ViewGroup paramViewGroup, SpannableStringBuilder paramSpannableStringBuilder, int paramInt1, int
            paramInt2, int paramInt3) {
    ...
    private void addH5TextView(Context paramContext, ViewGroup paramViewGroup, SpannableStringBuilder paramSpannableStringBuilder, int paramInt1, int
            paramInt2, int paramInt3) {
        this.ntv = new SelectTextView(paramContext);
        this.ntv.setSingleLine(false);
        ntv.setTextIsSelectable(true);
    ...
    private void addH6TextView(Context paramContext, ViewGroup paramViewGroup, SpannableStringBuilder paramSpannableStringBuilder, int paramInt1, int
            paramInt2, int paramInt3) {
        this.ntv = new SelectTextView(paramContext);
        this.ntv.setSingleLine(false);
        ntv.setTextIsSelectable(true);
    ...
    private void addImageView(final Activity paramActivity, SpannableStringBuilder paramSpannableStringBuilder, ViewGroup paramViewGroup, String imgWidth,
                              String imgHeight, String imgUrl) {
        ...
        ArmsUtils.getImageLoader(paramActivity).loadImage(paramActivity, ImageConfigImpl.builder().url(imgUrl).imageView(localImageView).build());
    }
    ...
    private void addTextSpanView(Context paramContext, ViewGroup paramViewGroup, SpannableStringBuilder paramSpannableStringBuilder, int paramInt1, int
            paramInt2, int paramInt3) {
        this.ntv = new SelectTextView(paramContext);
        this.ntv.setSingleLine(false);
        ntv.setLineSpacing(1.5f, 1.8f);
    ...
    private void addStrongTextSpanView(Context paramContext, ViewGroup paramViewGroup, SpannableStringBuilder paramSpannableStringBuilder, int paramInt1, int
            paramInt2, int paramInt3) {
        this.ntv = new SelectTextView(paramContext);
        this.ntv.setSingleLine(false);
        ntv.setLineSpacing(1.5f, 1.8f);
    ...
    private void paintBlockTextView(Context paramContext, ViewGroup paramViewGroup, SpannableStringBuilder paramSpannableStringBuilder, int paramInt1, int
            paramInt2) {
    ...
    private void putTextSpanViewSettings(TextView paramTextView, SpannableStringBuilder paramSpannableStringBuilder, int paramInt1, int paramInt2, int
            paramInt3) {
        paramTextView.setText(paramSpannableStringBuilder, TextView.BufferType.SPANNABLE);
        paramTextView.setGravity(Gravity.LEFT);
    }

    public void addTypeView(Activity paramActivity, ViewGroup paramViewGroup, int type, SpannableStringBuilder paramSpannableStringBuilder, String imgWidth,
                            String imgHeight, String imgUrl, int wordsLength, int spaces) {
