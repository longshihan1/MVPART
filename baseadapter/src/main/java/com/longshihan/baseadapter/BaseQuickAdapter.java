...
import com.longshihan.baseadapter.entity.IExpandable;
import com.longshihan.baseadapter.listener.OnAdapterListener;
import com.longshihan.baseadapter.loadmore.LoadMoreView;
import com.longshihan.baseadapter.loadmore.SimpleLoadMoreView;
import com.longshihan.baseadapter.util.MultiTypeDelegate;
...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    public boolean setOnItemLongClick(View v, int position) {
        if (mOnItemLongClickListener!=null){
            return mOnItemLongClickListener.onItemLongClick(BaseQuickAdapter.this, v, position);
        }else {
            return false;
        }
    ...
    private void addAnimation(RecyclerView.ViewHolder holder) {
            if (!mFirstOnlyEnable || holder.getLayoutPosition() > mLastPosition) {
                if (adapterListener!=null){
                    adapterListener.onBindAnimation(holder);
                }
