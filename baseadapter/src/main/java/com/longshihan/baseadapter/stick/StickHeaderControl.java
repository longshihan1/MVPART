...
public class StickHeaderControl {
    ...
    private String TAG=StickHeaderControl.class.getSimpleName();
     ...
     * @param builder
     */
    public StickHeaderControl(Builder builder) {
        this.builder = builder;
        if (builder!=null&&builder.getWrapper()!=null&&builder.getRecyclerView() != null&&builder.getRecyclerView().getAdapter()!=null) {
            recyclerView = builder.getRecyclerView();
            adapter = builder.getRecyclerView().getAdapter();
    ...
    public void goStick() {
        decor = new StickyAnyDecoration(wrapper);
