...
public class StickyAnyDecoration extends RecyclerView.ItemDecoration {
    ...
    private StickHeaderListener wrapper;
    private int gravity = Gravity.LEFT;

    public StickyAnyDecoration(StickHeaderListener wrapper) {
    ...
    private boolean hasHeader(int position) {
        return wrapper.isHeader(position);
    }
    ...
    private void cacaheHeaderView(RecyclerView parent, int position, ViewParams view) {
        if (!mHeaderCache.containsKey(position)) {
            RecyclerView.ViewHolder holder = wrapper.onCreateHeaderViewHolder(parent, position);
            final View header = holder.itemView;
            wrapper.onBindHeaderViewHolder(holder, position);
