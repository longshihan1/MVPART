...
public class ArmsUtils {
    ...
    public static AppComponent obtainAppComponentFromContext(Activity activity) {
        return obtainAppComponentFromContext((Context)activity);
    }
    public static AppComponent obtainAppComponentFromContext(Fragment fragment) {
        return obtainAppComponentFromContext(fragment.getActivity());
    }
    public static AppComponent obtainAppComponentFromContext(android.support.v4.app.Fragment fragment) {
        return obtainAppComponentFromContext(fragment.getActivity());
    }
    ...
    public static ImageLoader getImageLoader(android.support.v4.app.Fragment fragment){
        return obtainAppComponentFromContext(fragment).imageLoader();
    }
