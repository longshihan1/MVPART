...
package com.longshihan.mvplh.utils;
...
/**
 * @author longshihan
 * @time 2017/8/18 11:32
 * @des 防止Recyclerview 刷新出现闪烁
 *//*
...
public class NoAlphaItemAnimator extends RecyclerView.ItemAnimator {
    ...
    @Override
    public boolean animateChange(@NonNull ViewHolder oldHolder, @NonNull ViewHolder newHolder, @NonNull ItemHolderInfo preLayoutInfo, @NonNull ItemHolderInfo
            postLayoutInfo) {
        return false;
    }
